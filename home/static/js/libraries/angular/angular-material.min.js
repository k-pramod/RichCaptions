...
!function (e, t, n) {
    ...
    !function () {
        ...
        !function () {
            ...
            var f, g, b, v = /(-gt)?-(sm|md|lg|print)/g, E = /\s+/g, $ = ["grow", "initial", "auto", "none", "noshrink", "nogrow"], M = ["row", "column"], y = ["", "start", "center", "end", "stretch", "space-around", "space-between"], C = ["", "start", "center", "end", "stretch"], A = {
                enabled: !0,
                breakpoints: []
            };
        ...
        }, g = "1px 1px 0px rgba(0,0,0,0.4), -1px -1px 0px rgba(0,0,0,0.4)", b = "", v = s("rgba(0,0,0,0.87)"), E = s("rgba(255,255,255,0.87)"), $ = s("rgb(255,255,255)"), M = ["primary", "accent", "warn", "background"], y = "primary", C = {
            accent: {
                "default": "A200",
                "hue-1": "A100",
                "hue-2": "A400",
        ...
        function e(e, o, r, i) {
            function a(n, a, d, c) {
                ...
                function h(e, t, n, o, r, i, a) {
                    var d = 1 / n * 100, c = (n - 1) / n, s = _({
                        share: d,
                        gutterShare: c,
                        gutter: r
                    }), l = {
                        left: x({unit: s, offset: e.col, gutter: r}),
                        width: N({unit: s, span: t.col, gutter: r}),
                        paddingTop: "",
                        marginTop: "",
                        top: "",
                        height: ""
                    ...
                    switch (i) {
                        case"fixed":
                            l.top = x({unit: a, offset: e.row, gutter: r}), l.height = N({
                                unit: a,
                                span: t.row,
                                gutter: r
                            });
                        ...
                        case"ratio":
                            ...
                            l.paddingTop = N({unit: u, span: t.row, gutter: r}), l.marginTop = x({
                                unit: u,
                                offset: e.row,
                                gutter: r
                            });
                        ...
                        case"fit":
                            ...
                            l.top = x({unit: u, offset: e.row, gutter: r}), l.height = N({
                                unit: u,
                                span: t.row,
                                gutter: r
                            })
                ...
                function f(e, t, n, o, r) {
                    ...
                    switch (o) {
                        case"fixed":
                            ...
                            break;
                        case"ratio":
                            var a = 1 === e ? 0 : (e - 1) / e, d = 1 / e * 100, c = d * (1 / r), s = _({
                                share: c,
                                gutterShare: a,
                                gutter: n
                            });
            ...
            function c(a, c) {
                ...
                return h = o.supplant(h, [p, a.html()]), a.empty().append(s), a.append(h), c.tabindex || c.$set("tabindex", 0), function (a, c, s, l) {
                    ...
                    s.$observe("ngMultiple", function (e) {
                        ...
                        t.isString(e) && (e = !0), E !== n && E === e || (E = e, e ? c.attr({"aria-disabled": "true"}).removeAttr("tabindex").off("click", v).off("keydown", b) : c.attr({
                            tabindex: s.tabindex,
                            "aria-disabled": "false"
        ...
        function a(e) {
            function o(e, o, s, l, m, u, p, h, f) {
                ...
                function E(e, n, o) {
                    var m, u = n[0], p = o.target[0].children[0], h = f[0].body, g = o.selectEl[0], b = o.contentEl[0], v = h.getBoundingClientRect(), E = p.getBoundingClientRect(), $ = !1, M = {
                        left: v.left + d,
                        top: d,
                        bottom: v.height - d,
                    ...
                    }, C = v.width - 2 * d, A = g.querySelector("md-option[selected]"), k = g.getElementsByTagName("md-option"), T = g.getElementsByTagName("md-optgroup"), w = c(n, b), _ = r(o.loadingAsync);
        ...
        function o(e, n, o, r, i, a, d, c, s, l) {
            ...
            function u(o, m, u, p) {
                ...
                var V = p[0] || {
                    ...
                    }, W = p[1], Y = (t.element(r.getClosest(m, "_md-slider-container", !0)), u.ngDisabled ? t.bind(null, c(u.ngDisabled), o.$parent) : function () {
        ...
        function e(e) {
            function o(e, o, a, d, c, s, l, m, u) {
                ...
                function E(t, o) {
                    ...
                    var s, l = t[0], m = t[0].firstElementChild, u = m.getBoundingClientRect(), p = d[0].body, h = p.getBoundingClientRect(), f = c.getComputedStyle(m), g = o.target[0].querySelector("[md-menu-origin]") || o.target[0], b = g.getBoundingClientRect(), v = {
                        left: h.left + i,
