    ...
    return function a(e, t, r) {
            ...
            p.prototype.parseAtom = function () {
                ...
                while (true) {
                    ...
                    if (a.text === "\\limits" || a.text === "\\nolimits") {
                        if (!e || e.type !== "op") {
                            throw new u("Limit controls must follow a math operator", this.lexer, this.pos)
                        } else {
                            var i = a.text === "\\limits";
                            e.value.limits = i;
            ...
            p.prototype.parseArguments = function (e, t) {
                ...
                for (var l = 0; l < r; l++) {
                    ...
                    if (l < t.numOptionalArgs) {
                        ...
                        if (!p) {
                            if (!this.settings.throwOnError && this.nextToken.text[0] === "\\") {
                                p = new c(this.handleUnsupportedCmd(this.nextToken.text), false)
                            } else {
        ...
        11: [function (e, t, r) {
            ...
            v.sqrt = function (e, t) {
                var r;
                if (e.value.index) {
                    r = new n.MathNode("mroot", [f(e.value.body, t), f(e.value.index, t)])
                } else {
